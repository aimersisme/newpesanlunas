# PesanLunas v0.2.11-r2 — FULL CLIENT INSTALLER
...
If you already run PesanLunas v0.2.10, do NOT rerun the full master schema. Run `PesanLunas_v0.2.11-r2_HUTANG_PIUTANG_PATCH.sql` once in the existing Supabase project.
